...
const LessonRequestsTable = (props) => {
    ...
    return (
        ...
        >
          ...
          <DialogContent>
            <TextField margin='normal' fullWidth label="Title" placeholder="Note title" onChange={e => setTitle(e.target.value)}/>
            <Autocomplete
            ...
            <PerfectScrollbar>
                ...
                <Table>
                    ...
                    {lessonRequests.slice(page * limit, page * limit + limit).map(item => (
                        ...
                        <TableCell>
                            <Chip
                            color={item.lesson && item.lesson.isCompleted ? "primary" : item.isCancelled ? "secondary": "pending"}
